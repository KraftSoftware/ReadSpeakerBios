...
namespace Read_Speaker_Bios
{
    ...
    class TwitterApi
    {
        ...
        //const string TwitterApiBaseUrl = "https://ads-api.twitter.com/5/";
        ...
        public Task<string> Tweet(string text)
        {
            ...
            //{ "text", text },
            //{ "trim_user", "1" },
            //    {"scheduled_at", "2019-12-31T23:59:59Z" }
            //};

            //string keytotry = "17x2gw";
            //return SendRequest($"accounts/{keytotry}/scheduled_tweets", datas);
            // { "execute_at", ToUnixTime(DateTime.Now.AddMonths(1)).ToString() }
        }
